...
The number of common songs in the 4 lists we have is few. In this respect, the musical notes used mainly in songs on a country basis can be obtained from the plot.
...
The following table shows the sentiment intensity of the songs in the playlists, grouped by country. The analysis shows that 43 songs in the Brazilian list are in the Happy/Joyful sentiment class. In other lists, although the Happy/Joyful is superior, the Turbulent/Angry appears to be in close numbers. However, the analysis shows that the lists for these four countries are in the Happy/Joyful sentiment class.
...
For proper sentiment analyse, we calculate the percantages of sentiments in every month. With percantages, we can compare the users emotional preferences in months.
...
Spotify offer us Turkey's playlists in 1980, 1990, 2000, 2010 decades. These playlists includes just 50 songs per decade. Thus, we use sentiment percantage again for compare decades and last 3 years data.

#### Key Takeaways: 
* As a genuinely restless nation, we seem to have an allergy against "Chill/Peaceful" music.
* We can see climbing of "Turbulent/Angry" music after 1990's. The climb is even more steep with 2010's.
* While more "Happy/Joyful" music is listened to after 1980's, we can see a significant decline after 2010's.
...
Sentiment count of all unique songs between 2017 nad 2019.
