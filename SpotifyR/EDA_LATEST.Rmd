...
We analyzed the sentiments of current Turkey, USA, Brazil, Japan Top 50 playlists in Spotify and compared them. After that we analyzed the sentiment change in daily Turkey Top 200 playlists between 2017 and 2019 so far.

* In Turkey Top 200 data analysis (Chapter 6.3.2), we see that in June 2016, Turbulent/Angry songs have more percantange than Happy/Joyful songs. In yearly anlysis (Chapter 6.3.3), Happy/Joyful songs have more percantage than other senitments until 2018 and decreasing since 1990's. Beside that, Turbulent/Angry songs percantage increasing since 1990's.
