...
## 2. Gathering Turkey, USA, Japan and Brazil Top 50 Playlists
```{r message=FALSE, warning=FALSE}
#Get Turkey Top 50
...
## 3. Adding Sentiments in Each Track
...
### 4.3 .Danceability Density of Playlists
```{r message=FALSE, warning=FALSE, fig.height = 10, fig.width = 12}
...
### 4.4. Energy and Valence Range of Playlists
```{r message=FALSE, warning=FALSE}
...
### 4.4.1. Energy and Valence Range of Playlists with Dumbbell Plot
```{r message=FALSE, warning=FALSE, fig.height = 10, fig.width = 12}
...
### 4.6. Mean Excitement of Playlists
```{r message=FALSE, warning=FALSE, fig.height = 10, fig.width = 12}
...
### 4.7. Sentiment Analysis of Country Playlists with Gradient Chart
```{r message=FALSE, warning=FALSE}
...
### 4.7.1. Group of sentiment count by each contry
...
```
## 5. Turkey Top 200 Daily Data Between 2017-2019 
...
### 5.1 Monthly Change in Total Streams
...
### 5.3. Sentiment Analysis of Tracks
...
#### 5.3.1 Sentiment Gradient Chart
```{r message=FALSE, warning=FALSE, fig.height = 10, fig.width = 12}
